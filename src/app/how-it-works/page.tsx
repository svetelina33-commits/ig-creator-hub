            ...
            <div className="grid grid-cols-12 gap-8">
              ...
              <div className="col-span-12 md:col-span-8 space-y-6">
                <p className="text-[17px] leading-[1.75] text-ink-muted font-serif-book">
                  ...
                  introduction — write directly to <a className="text-forest underline underline-offset-4" href="mailto:arcrxx@gmail.com">arcrxx@gmail.com</a> with a rough brief, budget, and timing. We'll confirm fit and open a campaign on your behalf.
                </p>
                <p className="text-[17px] leading-[1.75] text-ink-muted font-serif-book">
